              ...
              Expanded(
                child: 
                  ...
                  child: DecoratedBox(
                    ...
                    Text(
                      'SCIENCE',
                      style: TextStyle(fontSize: 20.0, fontStyle: FontStyle.italic, color: Colors.white, fontWeight: FontWeight.bold)
                    )
                      ],
                    ),
                    decoration: new BoxDecoration(
              ...
              Expanded(
                child: 
                  Card(
                    ...
                    color: Colors.white,
                  margin: EdgeInsets.only(right: 5.0, left: 10.0, top: 20.0),
                  child: DecoratedBox(
                    child: Row(
                      children: <Widget>[
                       new IconButton(
            ...
            children: [
              Expanded(
                child: 
                  ...
                  margin: EdgeInsets.only(left: 5.0, right: 10.0, top: 20.0, bottom: 20.0),
                  child: DecoratedBox(
                    child: Row(
                      children: <Widget>[
                       new IconButton(
              ...
              Expanded(
                child: 
                  Card(
                    ...
                    color: Colors.white,
                  margin: EdgeInsets.only(right: 5.0, left: 10.0, top: 20.0, bottom: 20.0),
                  child: DecoratedBox(
                    child: Row(
                      children: <Widget>[
                       new IconButton(
